...
public class NormalRecycleViewAdapter$NormalTextViewHolder$$ViewBinder<T extends com.example.mezereon.bookexchange.Adapter.NormalRecycleViewAdapter.NormalTextViewHolder> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131493047, "field 'relativeLayout'");
    target.relativeLayout = finder.castView(view, 2131493047, "field 'relativeLayout'");
